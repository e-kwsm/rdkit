...
class RDKIT_SIMDIVPICKERS_EXPORT MaxMinPicker : public DistPicker {
 public:
   ...
   *              arguments and returning the distance (as a double) between
   *              those two elements.
   *   \param poolSize - the size of the pool to pick the items from. It is
   *              assumed that the distance matrix above contains the right
   *              number of elements; i.e. poolSize*(poolSize-1)
