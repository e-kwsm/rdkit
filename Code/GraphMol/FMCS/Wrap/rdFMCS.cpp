...
struct PyMCSAtomCompare : public PyMCSWrapper {
 public:
  ...
  const char *subclassName() const { return "MCSAtomCompare"; }
...
struct PyMCSBondCompare : public PyMCSWrapper {
  ...
  const char *subclassName() const { return "MCSBondCompare"; }
...
struct PyMCSProgress : public PyMCSWrapper {
  ...
  const char *subclassName() const { return "MCSProgress"; }
...
struct PyMCSFinalMatchCheck : public PyMCSWrapper {
  ...
  const char *subclassName() const { return "MCSFinalMatchCheck"; }
