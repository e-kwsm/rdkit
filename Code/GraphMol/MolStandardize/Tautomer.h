...
class RDKIT_MOLSTANDARDIZE_EXPORT TautomerEnumerator {
 public:
  ...
  unsigned int getMaxTautomers() const { return d_maxTautomers; }
  ...
  unsigned int getMaxTransforms() const { return d_maxTransforms; }
   ...
   */
  bool getRemoveSp3Stereo() const { return d_removeSp3Stereo; }
   ...
   */
  bool getRemoveBondStereo() const { return d_removeBondStereo; }
   ...
   */
  bool getRemoveIsotopicHs() const { return d_removeIsotopicHs; }
   ...
   */
  bool getReassignStereo() const { return d_reassignStereo; }
  ...
  /*!
    The enumeration rules are inspired by the publication: M. Sitzmann et al.,
    “Tautomerism in Large Databases.”, JCAMD 24:521 (2010)
    ...
    Notes:
      - the definitions used here are that the atoms modified during
        ...
        transform (the H "donor" and H "acceptor" in the transform) and the
