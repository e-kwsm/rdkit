...
class RDKIT_MOLSTANDARDIZE_EXPORT MolVSValidations {
 public:
  ...
  virtual std::shared_ptr<MolVSValidations> copy() const = 0;
};
...
class RDKIT_MOLSTANDARDIZE_EXPORT NoAtomValidation final
 ...
 public:
  ...
  //! pointer to it
  std::shared_ptr<MolVSValidations> copy() const override {
...
class RDKIT_MOLSTANDARDIZE_EXPORT MolVSValidation : public ValidationMethod {
 ...
 private:
  std::vector<std::shared_ptr<MolVSValidations>> d_validations;
};
