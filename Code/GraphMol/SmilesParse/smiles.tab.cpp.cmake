...
static const yytype_int16 yyrline[] = {
    0,   120, 120, 123, 127, 130, 134, 138, 141, 146, 149, 157, 158, 159, 160,
    168, 179, 190, 211, 220, 226, 247, 271, 290, 300, 321, 329, 343, 346, 347,
    353, 354, 360, 368, 369, 370, 371, 372, 373, 374, 378, 379, 380, 381, 382,
    383, 384, 385, 386, 390, 391, 392, 393, 394, 398, 399, 400, 401, 402, 403,
    407, 408, 412, 413, 414, 415, 416, 417, 418, 422, 423, 427, 428, 439, 440};
#endif
...
static const yytype_int16 yypact[] = {
    128, -8,  51,  5,   45,  1,   -22, -22, -22, 84,  98,  -22, -22, -22,
    -22, -22, 19,  78,  14,  78,  78,  -22, 15,  -22, 81,  28,  -2,  30,
    117, 109, -22, -22, 36,  -22, 39,  -22, 12,  -22, -22, -22, -22, -22,
    51,  25,  63,  25,  106, -22, -22, -22, 14,  78,  -22, -22, -22, 12,
    -22, -22, -5,  54,  14,  50,  14,  -22, 72,  14,  -22, -22, -22, -22,
    14,  -22, -22, -22, -22, 109, 109, -22, -22, 51,  51,  -22, -22, -22,
    -22, -22, -22, -22, -22, -22, 14,  -22, 75,  -22, 127, -22, -22, -22,
    -22, -22, 131, -22, 135, -22, 139, -22, 103, -22};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_int8 yydefact[] = {
    0,  0,  0,  0,  7,  0,  10, 61, 60, 0,  2,  15, 30, 56, 71, 69, 40, 0,
    0,  0,  0,  4,  0,  14, 33, 46, 49, 54, 0,  70, 29, 28, 6,  1,  0,  9,
    0,  54, 73, 74, 27, 26, 0,  0,  0,  0,  0,  16, 20, 62, 42, 0,  13, 58,
    11, 14, 12, 3,  37, 34, 47, 50, 52, 57, 41, 0,  55, 72, 5,  8,  0,  32,
    19, 18, 22, 0,  0,  17, 21, 0,  0,  23, 44, 38, 39, 35, 36, 48, 51, 53,
    43, 59, 0,  63, 0,  25, 24, 45, 31, 64, 0,  65, 0,  66, 0,  67, 0,  68};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-22, -22, 49,  -22, -22, -22, -3,  52,
                                      -22, -22, -22, 0,   37,  -12, -22, -21};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {0,  5,  54, 10, 46, 32, 11, 23,
                                        24, 25, 26, 12, 48, 28, 29, 49};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_int8 yytable[] = {
    22, 33, 34, 27, 14, 15,  53, 47,  67, 37, 83, 7,   13, 8,   14, 15,  61,
    37, 6,  37, 37, 62, 16,  14, 15,  17, 18, 35, 66,  19, 20,  7,  70,  8,
    38, 39, 50, 71, 82, 72,  73, 57,  77, 81, 44, 60,  84, 86,  87, 9,   89,
    37, 21, 91, 93, 94, -30, 7,  92,  8,  30, 36, 68,  14, 15,  69, 52,  31,
    88, 56, 85, 55, 75, 100, 76, 9,   95, 96, 97, 102, 74, 104, 78, 106, 7,
    13, 8,  14, 15, 90, 7,   13, 8,   14, 15, 16, 58,  59, 17,  18, 98,  16,
    51, 20, 7,  18, 8,  38,  39, 40,  41, 42, 7,  43,  8,  107, 0,  44,  38,
    39, 45, 79, 9,  7,  63,  8,  0,   0,  80, 1,  9,   2,  3,   4,  64,  0,
    38, 39, 65, 99, 38, 39,  0,  101, 38, 39, 0,  103, 38, 39,  0,  105};

static const yytype_int8 yycheck[] = {
    3,  0,  1,  3,  9,  10, 18, 10, 29, 9,  15, 6,   7,  8,   9,  10,  18,
    17, 26, 19, 20, 23, 17, 9,  10, 20, 21, 26, 28,  24, 25,  6,  20,  8,
    9,  10, 17, 25, 50, 42, 43, 26, 45, 46, 19, 17,  58, 59,  60, 24,  62,
    51, 3,  65, 75, 76, 26, 6,  70, 8,  15, 9,  26,  9,  10,  26, 17,  22,
    18, 20, 16, 19, 9,  94, 11, 24, 79, 80, 90, 100, 43, 102, 45, 104, 6,
    7,  8,  9,  10, 17, 6,  7,  8,  9,  10, 17, 15,  16, 20,  21, 25,  17,
    24, 25, 6,  21, 8,  9,  10, 11, 12, 13, 6,  15,  8,  12,  -1, 19,  9,
    10, 22, 15, 24, 6,  7,  8,  -1, -1, 22, 1,  24,  3,  4,   5,  17,  -1,
    9,  10, 21, 12, 9,  10, -1, 12, 9,  10, -1, 12,  9,  10,  -1, 12};

/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
static const yytype_int8 yystos[] = {
    0,  1,  3,  4,  5,  28, 26, 6,  8,  24, 30, 33, 38, 7,  9,  10, 17, 20,
    21, 24, 25, 29, 33, 34, 35, 36, 37, 38, 40, 41, 15, 22, 32, 0,  1,  26,
    34, 38, 9,  10, 11, 12, 13, 15, 19, 22, 31, 33, 39, 42, 17, 24, 29, 40,
    29, 34, 29, 26, 15, 16, 17, 18, 23, 7,  17, 21, 38, 42, 26, 26, 20, 25,
    33, 33, 39, 9,  11, 33, 39, 15, 22, 33, 40, 15, 40, 16, 40, 40, 18, 40,
    17, 40, 40, 42, 42, 33, 33, 40, 25, 12, 42, 12, 42, 12, 42, 12, 42, 12};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] = {
    0,  27, 28, 28, 28, 28, 28, 28, 28, 28, 28, 29, 29, 29, 29, 30, 30, 30, 30,
    30, 30, 30, 30, 30, 30, 30, 30, 31, 32, 32, 33, 33, 33, 34, 34, 34, 34, 34,
    34, 34, 35, 35, 35, 35, 35, 35, 35, 35, 35, 36, 36, 36, 36, 36, 37, 37, 37,
    37, 37, 37, 38, 38, 39, 39, 39, 39, 39, 39, 39, 40, 40, 41, 41, 42, 42};

/* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.
 */
static const yytype_int8 yyr2[] = {
    0, 2, 2, 3, 2, 3, 2, 1, 3, 2, 2, 2, 2, 2, 1, 1, 2, 3, 3, 3, 2, 3, 3, 3, 4,
    4, 2, 1, 1, 1, 1, 5, 3, 1, 2, 3, 3, 2, 3, 3, 1, 2, 2, 3, 3, 4, 1, 2, 3, 1,
    2, 3, 2, 3, 1, 2, 1, 2, 2, 3, 1, 1, 1, 3, 4, 5, 6, 7, 8, 1, 1, 1, 2, 1, 1};
...
yyreduce:
  ...
  switch (yyn) {
    ...
    case 31: /* atomd: ATOM_OPEN_TOKEN charge_element COLON_TOKEN number
                ATOM_CLOSE_TOKEN  */
    {
    ...
    case 64: /* ring_number: PERCENT_TOKEN GROUP_OPEN_TOKEN digit
                GROUP_CLOSE_TOKEN  */
    {
      (yyval.ival) = (yyvsp[-1].ival);
    } break;

    case 65: /* ring_number: PERCENT_TOKEN GROUP_OPEN_TOKEN digit digit
                GROUP_CLOSE_TOKEN  */
    {
      (yyval.ival) = (yyvsp[-2].ival) * 10 + (yyvsp[-1].ival);
    } break;

    case 66: /* ring_number: PERCENT_TOKEN GROUP_OPEN_TOKEN digit digit digit
                GROUP_CLOSE_TOKEN  */
    {
      (yyval.ival) =
