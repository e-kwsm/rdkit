...
BOOST_PYTHON_MODULE(rdRascalMCES) {
  ...
  python::class_<RDKit::RascalMCES::RascalOptions, boost::noncopyable>(
      ...
      .def_readwrite(
          ...
          "If True (default is False), only complete rings present in both "
          "input molecule's RingInfo will be returned. "
          "Implies completeAromaticRings and ringMatchesRingOnly.")
      .def_readwrite(
