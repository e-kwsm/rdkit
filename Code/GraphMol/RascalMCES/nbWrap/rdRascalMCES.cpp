...
NB_MODULE(rdRascalMCES, m) {
  ...
  nb::class_<RDKit::RascalMCES::RascalResult>(
      m, "RascalResult", "Used to return RASCAL MCES results.")
      .def_prop_ro("smartsString", &RDKit::RascalMCES::RascalResult::getSmarts,
...
MCES as tuples of bond indices from mol1 and mol2)DOC")
      ...
      .def(
          "largestFragmentOnly",
          [](RDKit::RascalMCES::RascalResult &self) { self.largestFragOnly(); },
      ...
      .def_prop_ro("tier1Sim", &RDKit::RascalMCES::RascalResult::getTier1Sim,
                   "The tier 1 similarity estimate.")
      .def_prop_ro("tier2Sim", &RDKit::RascalMCES::RascalResult::getTier2Sim,
                   "The tier 2 similarity estimate.")
      .def_prop_ro("timedOut", &RDKit::RascalMCES::RascalResult::getTimedOut,
...
as different.  Default=True.)DOC")
      .def_rw("minCliqueSize", &RDKit::RascalMCES::RascalOptions::minCliqueSize,
...
- opts Optional RascalOptions object changing the default run mode.)DOC");
  ...
  nb::class_<RDKit::RascalMCES::RascalClusterOptions>(
      m, "RascalClusterOptions",
...
isn't a lot of small fragments scattered around the molecules giving an inflated estimate of similarity.)DOC")
      ...
      .def_rw("b", &RDKit::RascalMCES::RascalClusterOptions::b,
