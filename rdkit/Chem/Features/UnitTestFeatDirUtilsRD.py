...
class TestCase(unittest.TestCase):
  ...
  def test1_GetDonor2FeatVects(self):
    ...
    self.assertAlmostEqual(vec_2.Length(), 1.5, msg='Incorrect length of vector 2')
  ...
  def test3_GetDonor2FeatVects(self):
    ...
    #Check initial point of the vector
    self.assertListAlmostEqual(case3[0][0][0], pos_heavy_atom, 'Incorrect starting point of vector')
