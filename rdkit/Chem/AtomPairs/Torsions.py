...
def pyScorePath(mol, path, size, atomCodes=None):
  ...
  >>> c0 = Utils.GetAtomCode(m.GetAtomWithIdx(0), 1)
  >>> c1 = Utils.GetAtomCode(m.GetAtomWithIdx(1), 2)
  >>> c2 = Utils.GetAtomCode(m.GetAtomWithIdx(2), 2)
  >>> c3 = Utils.GetAtomCode(m.GetAtomWithIdx(3), 1)
  >>> t = (c0 | (c1 << rdMolDescriptors.AtomPairsParameters.codeSize)
  ... | (c2 << (rdMolDescriptors.AtomPairsParameters.codeSize * 2))
  ... | (c3 << (rdMolDescriptors.AtomPairsParameters.codeSize * 3)))
  ...
  >>> c1 = Utils.GetAtomCode(m.GetAtomWithIdx(1), 2)
  >>> c2 = Utils.GetAtomCode(m.GetAtomWithIdx(2), 2)
  >>> c3 = Utils.GetAtomCode(m.GetAtomWithIdx(4), 1)
  >>> t = (c0 | (c1 << rdMolDescriptors.AtomPairsParameters.codeSize)
  ... | (c2 << (rdMolDescriptors.AtomPairsParameters.codeSize * 2))
  ... | (c3 << (rdMolDescriptors.AtomPairsParameters.codeSize * 3)))
