...
def _myimport(name, globals=None, locals=None, fromlist=None):
  """
    ...
    besides win32com modules automatically generated by win32com.gencache
    """
  try:
...
def set_gen_path(path):
  """
    ...
    If not set, all Modules (win32com) will be generated to support/gen_py of your application.
    """
  import os
